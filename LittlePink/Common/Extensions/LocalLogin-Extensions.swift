...
extension UIViewController{
    ...
    extension UIViewController{
        ...
        private func setLocalLoginUI(){
            ...
            //用户协议和隐私政策
            config.appPrivacyOne = ["用户协议","https://04192202.github.io/index.html"]
            config.appPrivacyTwo = ["隐私政策","https://github.com/04192202"]
...
extension UIViewController{
    ...
    private func getEncryptedPhoneNum(_ loginToken:String){
        ...
        let headers: HTTPHeaders = [
            .authorization(username: kJAppKey, password: "b39db8ec5e426dca9fd048fc")
        ]
